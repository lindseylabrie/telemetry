...
ggplot(rkm_tracker_date, aes(x=date, y=rkm, color=as.character(transmitter_id)))+
  geom_line()+ labs(title="USD/GFP James River Silver Carp Detections", subtitle ="June - November 2021.", 
...
ggplot(id_48470, aes(x=date, y=rkm, color=as.character(transmitter_id)))+
...
ggplot(id_48471, aes(x=date, y=rkm, color=as.character(transmitter_id)))+
...
ggplot(id_48472, aes(x=date, y=rkm, color=as.character(transmitter_id)))+
...
ggplot(id_48473, aes(x=date, y=rkm, color=as.character(transmitter_id)))+
